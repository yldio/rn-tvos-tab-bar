...
private:
  ...
  class JSI_EXPORT NativeTVNavigationEventEmitterCxxSpecJSI : public TurboModule {
protected:
  NativeTVNavigationEventEmitterCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
protected:
  NativeTVNavigationEventEmitterCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule("TVNavigationEventEmitter", jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}

private:
  class Delegate : public NativeTVNavigationEventEmitterCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeTVNavigationEventEmitterCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
